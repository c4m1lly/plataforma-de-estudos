...
SECRET_KEY = 'django-insecure-ret^cm0(sjyfd=e_58n*&!op$7o1(boa6j9$&hpq%fix+=co%3'
...
INSTALLED_APPS = [
    ...
    "rest_framework",
    "corsheaders",
    "rest_framework_simplejwt.token_blacklist",  # opcional
    "accounts", "learning", "courses", "quizzes",
]
